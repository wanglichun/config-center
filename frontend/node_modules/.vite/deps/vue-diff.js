...
// node_modules/vue-diff/dist/index.es.js
...
(function(e2) {
  ...
  t2.prototype.diff_main = function(e3, n3, i3, a2) {
    if (typeof a2 == "undefined")
      if (this.Diff_Timeout <= 0)
        ...
        a2 = (/* @__PURE__ */ new Date()).getTime() + 1e3 * this.Diff_Timeout;
    var s2 = a2;
    if (e3 == null || n3 == null)
  ...
  t2.prototype.diff_bisect_ = function(e3, r3, a2) {
    ...
    for (var y2 = 0; y2 < l2; y2++) {
      if ((/* @__PURE__ */ new Date()).getTime() > a2)
        break;
...
var Se = "[a-zA-Z_]\\w*";
var Re = "\\b\\d+(\\.\\d+)?";
var Te = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)";
var De = "\\b(0b[01]+)";
var Ie = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~";
var Ce = (e2 = {}) => {
  const t2 = /^#![ ]*\//;
...
var je = { begin: "\\\\[\\s\\S]", relevance: 0 };
var Be = { scope: "string", begin: "'", end: "'", illegal: "\\n", contains: [je] };
var Le = { scope: "string", begin: '"', end: '"', illegal: "\\n", contains: [je] };
var Pe = { begin: /\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/ };
...
var Ue = $e("/\\*", "\\*/");
var He = $e("#", "$");
var Ze = { scope: "number", begin: Re, relevance: 0 };
var Fe = { scope: "number", begin: Te, relevance: 0 };
var Ge = { scope: "number", begin: De, relevance: 0 };
var Ke = { begin: /(?=\/[^/\n]*\/)/, contains: [{ scope: "regexp", begin: /\//, end: /\/[gimuy]*/, illegal: /\n/, contains: [je, { begin: /\[/, end: /\]/, relevance: 0, contains: [je] }] }] };
var We = { scope: "title", begin: Me, relevance: 0 };
var qe = { scope: "title", begin: Se, relevance: 0 };
var Xe = { begin: "\\.\\s*" + Se, relevance: 0 };
var Je = function(e2) {
...
var at = ["of", "and", "for", "in", "not", "or", "if", "then", "parent", "list", "value"];
var st = "keyword";
...
var Ht = "[A-Za-z$_][0-9A-Za-z$_]*";
var Zt = ["as", "in", "of", "if", "for", "while", "finally", "var", "new", "function", "do", "return", "void", "else", "break", "catch", "instanceof", "with", "throw", "case", "default", "try", "switch", "continue", "typeof", "delete", "let", "yield", "const", "class", "debugger", "async", "await", "static", "import", "from", "export", "extends"];
var Ft = ["true", "false", "null", "undefined", "NaN", "Infinity"];
var Gt = ["Object", "Function", "Boolean", "Symbol", "Math", "Date", "Number", "BigInt", "String", "RegExp", "Array", "Float32Array", "Float64Array", "Int8Array", "Uint8Array", "Uint8ClampedArray", "Int16Array", "Int32Array", "Uint16Array", "Uint32Array", "BigInt64Array", "BigUint64Array", "Set", "Map", "WeakSet", "WeakMap", "ArrayBuffer", "SharedArrayBuffer", "Atomics", "DataView", "JSON", "Promise", "Generator", "GeneratorFunction", "AsyncFunction", "Reflect", "Proxy", "Intl", "WebAssembly"];
var Kt = ["Error", "EvalError", "InternalError", "RangeError", "ReferenceError", "SyntaxError", "TypeError", "URIError"];
var Wt = ["setInterval", "setTimeout", "clearInterval", "clearTimeout", "require", "exports", "eval", "isFinite", "isNaN", "parseFloat", "parseInt", "decodeURI", "decodeURIComponent", "encodeURI", "encodeURIComponent", "escape", "unescape"];
var qt = ["arguments", "this", "super", "console", "window", "document", "localStorage", "module", "global"];
var Xt = [].concat(Wt, Gt, Kt);
function Jt(e2) {
  const t2 = e2.regex;
...
var en = ["as", "in", "of", "if", "for", "while", "finally", "var", "new", "function", "do", "return", "void", "else", "break", "catch", "instanceof", "with", "throw", "case", "default", "try", "switch", "continue", "typeof", "delete", "let", "yield", "const", "class", "debugger", "async", "await", "static", "import", "from", "export", "extends"];
var tn = ["true", "false", "null", "undefined", "NaN", "Infinity"];
var nn = ["Object", "Function", "Boolean", "Symbol", "Math", "Date", "Number", "BigInt", "String", "RegExp", "Array", "Float32Array", "Float64Array", "Int8Array", "Uint8Array", "Uint8ClampedArray", "Int16Array", "Int32Array", "Uint16Array", "Uint32Array", "BigInt64Array", "BigUint64Array", "Set", "Map", "WeakSet", "WeakMap", "ArrayBuffer", "SharedArrayBuffer", "Atomics", "DataView", "JSON", "Promise", "Generator", "GeneratorFunction", "AsyncFunction", "Reflect", "Proxy", "Intl", "WebAssembly"];
var rn = ["Error", "EvalError", "InternalError", "RangeError", "ReferenceError", "SyntaxError", "TypeError", "URIError"];
var an = ["setInterval", "setTimeout", "clearInterval", "clearTimeout", "require", "exports", "eval", "isFinite", "isNaN", "parseFloat", "parseInt", "decodeURI", "decodeURIComponent", "encodeURI", "encodeURIComponent", "escape", "unescape"];
var sn = ["arguments", "this", "super", "console", "window", "document", "localStorage", "module", "global"];
var on = [].concat(an, nn, rn);
function ln(e2) {
  const t2 = e2.regex;
  const n2 = (e3, { after: t3 }) => {
    const n3 = "</" + e3[0].slice(1);
...
var fn = "<vue-diff-modified>";
var dn = "</vue-diff-modified>";
var un = ((e2) => {
...
var vn = ({ highlightCode: e2, language: t2, code: n2 }) => {
...
var _n = (e2, t2, n2) => {
  const i2 = ref([]);
  const s2 = ref([]);
  const o2 = computed(() => s2.value.filter((t3) => e2.folding ? !t3.foldable && t3.visible : t3.visible));
  const l2 = () => {
...
var yn = (t2, n2, i2, r2) => {
  ...
  G([() => t2.mode, () => t2.prev, () => t2.current, () => t2.folding], () => nextTick(f2), { debounce: t2.inputDelay, immediate: true });
  onMounted(() => {
    var _a;
    if (!i2.value)
      return;
...
var xn = defineComponent({ props: { language: { type: String, required: true }, code: { type: String, required: true }, scrollOptions: { type: [Boolean, Object], default: false } }, emits: ["rendered"], setup(t2, { emit: n2 }) {
  const i2 = ref("");
  onMounted(() => {
    watch([() => t2.language, () => t2.code], () => {
      vn({ highlightCode: i2, language: t2.language, code: t2.code });
      nextTick(() => n2("rendered"));
    }, { immediate: true });
    watch([() => t2.scrollOptions], () => {
      nextTick(() => n2("rendered"));
    }, { deep: true });
  });
...
function kn(e2, t2, n2, i2, r2, a2) {
  return openBlock(), createElementBlock("pre", null, [createBaseVNode("code", { class: "hljs", innerHTML: e2.highlightCode }, null, 8, En)]);
}
var Nn = wn(xn, [["render", kn]]);
var An = defineComponent({ components: { Code: Nn }, props: { mode: { type: String, required: true }, folding: { type: Boolean, default: false }, language: { type: String, required: true }, meta: { type: Object, required: true }, render: { type: Object, required: true }, scrollOptions: { type: [Boolean, Object], default: false } }, setup(e2, { emit: t2 }) {
  const n2 = ref(null);
  const i2 = computed(() => {
    if (!e2.scrollOptions)
      return;
  ...
  const s2 = computed(() => e2.folding && e2.render[0].type === "equal");
  const o2 = (e3, t3, n3) => {
    if (!e3.value)
      return "\n";
...
var On = createBaseVNode("div", { class: "lineNum vue-diff-cell-fold" }, null, -1);
var Mn = createBaseVNode("div", { class: "code vue-diff-cell-fold" }, null, -1);
var Sn = createBaseVNode("div", { class: "lineNum vue-diff-cell-fold" }, null, -1);
var Rn = createBaseVNode("div", { class: "code vue-diff-cell-fold" }, null, -1);
function Tn(e2, t2, n2, i2, r2, a2) {
  const s2 = resolveComponent("Code");
  return openBlock(), createElementBlock("div", { ref: "line", class: normalizeClass(["vue-diff-row", `vue-diff-row-${e2.mode}`]), style: normalizeStyle(e2.rowStyle) }, [e2.mode === "split" ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(e2.render, (t3, n3) => (openBlock(), createElementBlock(Fragment, { key: n3 }, [e2.isFoldLine ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [On, Mn], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [createBaseVNode("div", { class: normalizeClass(["lineNum", `vue-diff-cell-${t3.type}`]) }, toDisplayString(t3.lineNum), 3), createBaseVNode("div", { class: normalizeClass(["code", `vue-diff-cell-${t3.type}`]) }, [createVNode(s2, { language: e2.language, code: e2.setCode(t3, e2.render, n3), scrollOptions: e2.scrollOptions, onRendered: e2.rendered }, null, 8, ["language", "code", "scrollOptions", "onRendered"])], 2)], 64))], 64))), 128)) : createCommentVNode("", true), e2.mode === "unified" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [e2.isFoldLine ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [Sn, Rn], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [createBaseVNode("div", { class: normalizeClass(["lineNum", `vue-diff-cell-${e2.render[0].type}`]) }, toDisplayString(e2.render[0].lineNum), 3), createBaseVNode("div", { class: normalizeClass(["code", `vue-diff-cell-${e2.render[0].type}`]) }, [createVNode(s2, { language: e2.language, code: e2.setCode(e2.render[0]), scrollOptions: e2.scrollOptions, onRendered: e2.rendered }, null, 8, ["language", "code", "scrollOptions", "onRendered"])], 2)], 64))], 64)) : createCommentVNode("", true)], 6);
}
var Dn = wn(An, [["render", Tn]]);
var In = defineComponent({ components: { Line: Dn }, props: { mode: { type: String, default: "split" }, theme: { type: String, default: "dark" }, language: { type: String, default: "plaintext" }, prev: { type: String, default: "" }, current: { type: String, default: "" }, folding: { type: Boolean, default: false }, inputDelay: { type: Number, default: 0 }, virtualScroll: { type: [Boolean, Object], default: false } }, setup(e2) {
  const t2 = ref(null);
  const n2 = computed(() => {
    if (!e2.virtualScroll)
      return false;
    return __spreadValues({ height: 500, lineMinHeight: 24, delay: 100 }, typeof e2.virtualScroll === "object" ? toRaw(e2.virtualScroll) : {});
  });
...
function Cn(e2, t2, n2, i2, r2, a2) {
  const s2 = resolveComponent("Line");
  return openBlock(), createElementBlock("div", { class: normalizeClass(["vue-diff-wrapper", `vue-diff-mode-${e2.mode} vue-diff-theme-${e2.theme}`]) }, [createBaseVNode("div", { ref: "viewer", class: "vue-diff-viewer", style: normalizeStyle({ height: e2.scrollOptions ? e2.scrollOptions.height + "px" : void 0 }) }, [createBaseVNode("div", { class: "vue-diff-viewer-inner", style: normalizeStyle({ minHeight: e2.minHeight }) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(e2.list, (t3, n3) => (openBlock(), createBlock(s2, { key: n3, mode: e2.mode, folding: e2.folding, language: e2.language, meta: e2.meta[t3.index], render: e2.render[t3.index], scrollOptions: e2.scrollOptions, onSetLineHeight: e2.setLineHeight }, null, 8, ["mode", "folding", "language", "meta", "render", "scrollOptions", "onSetLineHeight"]))), 128))], 4)], 4)], 2);
}
...
//# sourceMappingURL=vue-diff.js.map
