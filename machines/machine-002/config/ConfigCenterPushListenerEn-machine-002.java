...
/**
 * Config Center Push Listener for Machine-002
...
public class ConfigCenterPushListenerEn {
    ...
    private static final String INSTANCE_ID = System.getenv().getOrDefault("INSTANCE_ID", "machine-002");
    ...
    public void start() {
        try {
            System.out.println("Starting Config Center Push Listener for Machine-002...");
